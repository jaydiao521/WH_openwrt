...
#sudo rm -rf ./feeds/packages/net/v2ray-geodata && cp -rf ./feeds/passwall/v2ray-geodata ./feeds/packages/net/v2ray-geodata
...
sudo rm -rf ./feeds/packages/net/adguardhome && cp -rf ./feeds/kenzo/adguardhome ./feeds/packages/net/adguardhome
#sudo rm -rf ./feeds/luci/applications/luci-app-mosdns
