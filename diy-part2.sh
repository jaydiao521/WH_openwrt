...
sed -i "9i uci set network.lan.dns='192.168.10.11'" ./package/lean/default-settings/files/zzz-default-settings  # 默认上游 DNS 地址
...
sed -i 's/root::0:0:99999:7:::/root:$1$15T8S9pF$4hfjTe2Q8IxjhD0F8gUlw.:18682:0:99999:7:::/g' /etc/shadow
#
